...
1. Verwende den Code unten um einen Violinen-Plot der `Calories` in Abhängigkeit der `Category` zu kreieren. Violinenplots zeigen mit ihrer Dicke die jeweilige relative Häufigkeit der Werte an - in diesem Fall der Kalorien. 
