...
<ul>
  <li class="m1"><span><high>Transformieren</high>: Intuitive Spaltennamen vergeben.
  <ul class="level">
    <li><span>Spaltennamen verändern</span></li>
    <li><span>Neue Variablen kreieren</span></li>
  </ul></span></li>
  <li class="m2"><span><high>Organisieren</high>: Intuitive Spaltennamen vergeben.
  <ul class="level">
    <li><span>Sortieren</span></li>
    <li><span>Datensätze zusammenführen</span></li>
    <li><span>Spalten zu Zeilen flippen</span></li>
  </ul></span></li>
    <li class="m3"><span><high>Aggregieren</high>: Intuitive Spaltennamen vergeben.
  <ul class="level">
...
<ul>
  <li class="m4"><span><span><high>Sortieren</high>: Datensatz ordnen.
  <br><br>
  <ul class="level">
...
```{r}
  # alter grösser 30 & bed_label ist drug
patienten_ergebnisse %>%
  filter(alter > 30,
