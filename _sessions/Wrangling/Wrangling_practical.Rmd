...
1. Verwende die `read_csv()` Funktion um den Datensatz `weather`, welcher das Wetter in Brasilien enthält, als Objekt `weather` einzulesen. Denke an den Trick mit den Anführungszeichen. 
...
10. Erstellt im nächsten Schritt der Pipeline erneut eine Variable `termin_eingelten_01` genauso wie ihr das vorher bereits einmal getan habt. Ausserdem erstellt eine Variable `niederschlag_01` die anzeigt, ob es Niederschlag gab oder nicht. 
