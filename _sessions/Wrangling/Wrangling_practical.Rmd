...
12. Finde nun mit der bekannten Form `data_frame$spalte1[data_frame$spalte2 == XX]` und der `mean()` Funktion heraus, ob Termine bei Regen seltener eingehalten wurden.  
