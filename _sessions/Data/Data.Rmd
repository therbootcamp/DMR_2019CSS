...
<high>`vector`</high> - R's data container
...
Merh info [hier](http://rspatial.org/intr/rst/4-indexing.html).
...
<highm>logical</highm> Vektoren werden typischerweise durch <high>logische Vergleiche</high> in Data Frames oder Vektoren bestimmte <high>Fälle auszuwählen</high>. 
...
<ul>
  ...
  <li class="m1"><span>Meist als <high>lokale Textdatei</high> vorliegend.</span></li>
  <li class="m1"><span><high>Datenklassen</high> werden inferiert.</span></li>
</ul>
