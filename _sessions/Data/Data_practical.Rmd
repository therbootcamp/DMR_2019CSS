...
3. Printe den `diamonds` Datensatz. Inspiziere insbesondere die Variablennamen. Etwas stimmt nicht.
...
3. Ergänze den Datensatz um die neue Variable `teuer`. Siehe Code.
...
In diesem Unterabschnitt liest du den `sleep` Datensatz, welcher Daten über das Schlafverhalten der Mitarbeiter der Universität Melbourne enthält, aus einem SPSS format ein und speicherst die Daten als `.csv`.
